...
class TrackedObject:
    def __init__(self, metadata, props_raw=[]):
        """
        frames: list of ints
        centroids: list of tuples of (row, col) of centroids of bubbles
        areas: same as centroids
        ...
        metadata :
            ...
            frame_dim : 2-tuple
                number of rows and number of columns in frame
    ...
    def offscreen_centroid(self, centroid):
        ...
        # extracts centroid
        row, col = centroid
        # extracts dimensions of the frame
        frame_dim = self.metadata['frame_dim']
        # gets direction to nearest boundary
        rev_dir_list = [(0,-1), (-1,0), (0,1), (1,0)]
        d_border_list = [col, row, frame_dim[1]-col, frame_dim[0]-row]
        rev_dir = rev_dir_list[np.argmin(d_border_list)]
